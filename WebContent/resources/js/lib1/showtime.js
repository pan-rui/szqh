...
function  uploadImg(id){
	window.showModalDialog("/daidaicj/index.php?q=uploadimg&id="+id, window, "dialogWidth: 400px; dialogHeight: 230px; help: no; scroll: no; status: no");
}
function  uploadAnnex(id){
	window.showModalDialog("/daidaicj/?q=uploadannex&id="+id, window, "dialogWidth: 400px; dialogHeight: 230px; help: no; scroll: no; status: no");
}
