...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="TableContract">
        ...
        <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">投资人：</fo:block>
        ...
        <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">投资接受人：</fo:block>
       ...
       -->
        <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt"> 担保公司：<xsl:value-of select="ENTERPRISE"/>  </fo:block>
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           甲方：向发起借款标的借款人提供资金的投资人</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         乙方：发起借款标的借款人（投资接受人）</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           丙方：中创晟业（北京）资本管理有限公司</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           丁方：承诺为乙方提供履约连带保证的担保公司</fo:block>
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            2、乙方因合法的经营活动及消费需要筹借资金临时	周转，自愿向甲方借款；</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            3、丙方基于甲方和乙方的委托，撮合甲乙双方依法建立借款法律关系，并为双方合同签订、借款交易完成、债权风险范防措施设定提供居间服务；</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            4、丁方是依据中华人民共和国法律及行政法规、规章等设立的从事融资性担保业务的企业法人，对借款人（投资接受人）的尽职调查，并为其提供履约连带责任担保；向投资接受人收取担保费，具体费用与投资接受人另行约定。</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            上述四方为借款与服务事宜，经平等协商一致签订本合同，以确认各方权利与义务。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
		            第一条	  承诺与保证</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          1、为投资事宜，甲方确认委托丙方联系借款人、确认与乙方建立合同关系是经丙方撮合而实现。 </fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            2、为借款事宜，乙方确认委托丙方联系投资人、确认与甲方建立合同关系是经丙方撮合而实现。 </fo:block>
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            1、乙方向甲方借款的金额，为甲方在丙方的百合贷网络服务平台（以下简称百合贷）通过规定程序操作自行确认并实际转入乙方账户的金额。  </fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           2、乙方向甲方借款的利率和期限，按借款人在百合贷发布的“借款标”明示的利率与期限确定，借款期限自甲方资金从甲方在“易极付”的账户转出之日起算，并且该日期也是甲方利息收益的起算日。</fo:block>   
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           3、乙方发布的“借款标”以“月”为期限计算单位，期限届满日为月数届满的那一月中与收到借款日对应的“日”，该月无此对应日的，为该月最后一日。如截止日为非工作日，则顺延至此后第一个工作日。 </fo:block>  
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           3、甲方在百合贷确认投资后，“易极付”将对甲方账户等额资金予以冻结。如果甲方在“易极付”的账户中实有资金额低于甲方确认的投资额，则甲方投资指令不能得到系统确认。甲方资金冻结期间，无权获得利息或者其他收益。</fo:block>  
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           4、甲方确认投资且其在“易极付”的相应资金被“易极付”冻结，但乙方“借款标”在规定日期内却没有筹满，则丙方将对乙方本次“借款标”予以撤标，丙方在撤标的同时指令“易极付”解除对甲方账户资金的冻结。</fo:block>  
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           第五条	  还本付息</fo:block>   
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           1、乙方支付甲方利息的方式，按百合贷公示的乙方“借款标”明示的方式执行。 </fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           2、乙方向甲方支付利息以及归还甲方投资款，由乙方在“易极付”开立的账户转入甲方在“易极付”开立的账户。乙方还本付息的资金到达甲方在“易极付”开立的账户，则表明甲方已收到乙方还本付息款，乙方已履行还本付息义务。</fo:block>   
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           3、乙方应在借款期限届满日12：00时前将还本付息的资金转入在“易极付”的账户，并自行发出指令将资金转入甲方在“易极付”的账户。</fo:block>  
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          4、乙方提前归还全部本金的，应按约定借款期间全额支付利息，并与全部本金一并支付。如果乙方提前归还全部本金但未将约定期间内全部利息一并支付，“易极付”将拒绝受理。</fo:block>  
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         ...
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          ...
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          1、如果约定的期限届满乙方不能足额偿还借款本息，则丁方应在还款期限届满日12：00时前为乙方代为清偿，偿还对甲方借款本息。</fo:block>    
           <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          2、丁方与乙方向确认，双方之间的担保合同已签订并生效且担保措施已落实，只要发生乙方到期不能偿还借款本息的情况，丁方将立即为乙方代偿，以保证甲方投资款本息按时收回。</fo:block>    
            <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          ...
          2、乙方应付甲方居间服务费，应在收到借款时支付，为此，乙方应授权丙方指令“易极付”在向乙方转付借款时支付给丙方。此项授权，乙方根据“易极付”的要求签订协议确认或者出具授权书进行授权。</fo:block>    
            <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          3、甲方因履行本合同而获得的收益，自行依法纳税。</fo:block>    
           <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
           第九条	  争议解决</fo:block>        
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         ...
         第十条	 合同附件</fo:block>        
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          乙方在百合贷发布的借款标及相关附件均为本合同的附件，构成本合同的组成部分。</fo:block>    
            <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         第十一条  合同生效</fo:block>        
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          本合同的签署方式为：</fo:block>    
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         甲方和乙方，通过在百合贷按设定程序进入账号进行相关操作，确认承认本方为本合同的对应当事人，享受本合同约定的权利，承担本合同约定的义务。甲方和乙方自行妥善保管账号和密码，并承担相应责任。丙方通过甲方和乙方的账户及密码来识别甲方和乙方的指令，甲方和乙方确认，使用的账户和密码登录后在百合贷上的一切行为均代表甲方和乙方本人。</fo:block>    
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
          丙方作为百合贷的建设与管理者，在百合贷上公示本合同，表明确认本合同对本方的约束力，享受本合约定的权利和履行本合同约定义务。</fo:block>    
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         丁方在百合贷上随借款标公示的《承诺书》，确认就该借款标承诺本合同对本方的约束力，按本合同丁方当事人享受权利和履行义务。</fo:block>    
          <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
        乙方：通过百合贷发出借款标的借款人（投资接受人）</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
        丙方：中创晟业（北京）资本管理有限公司</fo:block>
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
        丁方：承诺为乙方提供履约连带保证的担保公司</fo:block>
            ...
            <fo:table-header>
				<fo:table-row height="10pt" >
                    <fo:table-cell number-columns-spanned="4"  height="10pt">
                        <fo:block text-align="right"  wrap-option="wrap"> 编号： <xsl:value-of select="LETTERNO"/></fo:block>
                    </fo:table-cell>
                </fo:table-row>
                ...
                <fo:table-row height="30pt">
                    <fo:table-cell number-columns-spanned="4"  height="20pt" >
                        <fo:block text-align="center"  wrap-option="wrap"  font-weight="bold" font-size="20pt">投融资及担保合同</fo:block>
                    </fo:table-cell>
                </fo:table-row>
        ...
        <fo:table space-before.optimum="2pt" border-collapse="separate" font-size="10pt" border-width="0.5pt" border-style="normal">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold" font-size="10pt" border-width="0.5pt" border-style="solid">
                    ...
                    <fo:table-cell border-color="black" border-left-width="0.5pt" border-top-width="0.5pt" border-right-width="0.5pt" border-bottom-width="0.5pt" border-style="solid" height="10pt">
                        <fo:block text-align="center">借款人姓名</fo:block>
                    </fo:table-cell>
                </fo:table-row>
            </fo:table-header>
            ...
            <fo:table-body>
                <fo:table-row space-before.optimum="3pt" font-size="10pt">
                    ...
                    <fo:table-cell text-align="start" border-color="black" border-left-width="0.5pt" border-top-width="0pt" border-right-width="0.5pt" border-bottom-width="0.5pt" border-style="solid" height="10pt">
                        <fo:block text-align="center"   wrap-option="wrap" language="zh" >
                            <xsl:value-of select="loanerName"/>
                        </fo:block>
                    </fo:table-cell>
    ...
    <xsl:template match="investTable">
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-after="2pt"  line-height="17pt">
            投资权益本金合计 <xsl:value-of select="DMONEY"/> 万元人民币 </fo:block>

        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"   space-after="2pt"  line-height="17pt">
            投资权益年化收益率 <xsl:value-of select="PER"/> %</fo:block>

        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"   space-after="2pt"  line-height="17pt" >
            投资期间 <xsl:value-of select="SYYYY"/> 年 <xsl:value-of select="SMM"/> 月 <xsl:value-of select="SDD"/>日—  <xsl:value-of select="EYYYY"/> 年 <xsl:value-of select="EMM"/> 月 <xsl:value-of select="EDD"/>日
        </fo:block>
