    ...
    <xsl:template match="PageList">
     ...
     <xsl:template match="TableContract"> 
      ...
      <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">2.投资接受人：是指在<xsl:value-of select="productName"/>金融服务平台注册并同意相关服务协议，有资金需求及合法资金用途，承诺在到期时间无条件回购投资人的投资权益（包含本金和收益），并获得担保公司履约连带责任担保的自然人。</fo:block>      
	   ...
	   <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt"><xsl:value-of select="productName"/>金融平台确认投资接受人正常回购投资人的投资权益（包含本金及收益）后，委托易极付正常划款日为回购到期日届满后两个法定工作日之内。由担保公司代偿的，为回购到期日届满后三个法定工作日之内。</fo:block>
       ...
       <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.承诺提供的信息真实有效，投资资金来源合法，自愿向投资接受人进行投资形成投资权益（包含本金和收益）。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">5.当投资接受人或担保公司按照本合同约定履行了偿付义务，投资人同意并在此不可撤销地授权由<xsl:value-of select="platformName"/>代其向担保公司出具《解除担保责任告知函》或《代偿债务确认书》。</fo:block>
	   ...
	   <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.承诺提供的信息真实有效，不得隐瞒任何影响或可能影响其资信能力的事项。</fo:block>      
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">6、当投资接受人不能对投资人进行按时、足额回购投资权益（含投资人本金和收益）时，投资接受人同意并在此不可撤销地授权由<xsl:value-of select="platformName"/>代其向担保公司出具《代偿通知书》。</fo:block>  
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">7.本合同项下的投资收益权不得私下转让，转让须经过担保公司书面同意并在<xsl:value-of select="productName"/>金融网站平台登记方为有效。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">9.合同各方知悉并遵守《<xsl:value-of select="productName"/>金融服务平台服务协议》、《“投融保”业务合作协议》、《<xsl:value-of select="productName"/>金融服务有限公司网站费用及其他规则》、的规定，前述文本的修改必须经过担保公司书面同意，否则该等文本的修改对担保公司不产生任何效力。</fo:block>
       ...
       <!-- 定义表头 //-->
	     ...
	     <fo:table-row height="10pt">
	         <fo:table-cell number-columns-spanned="2"  height="10pt">
	          ...
	          <fo:table-cell >
	             <fo:block text-align="right"  wrap-option="wrap" >合同编号：</fo:block>
	         </fo:table-cell>
	          <fo:table-cell >
	             <fo:block text-align="right"  wrap-option="wrap"><xsl:value-of select="LETTERNO"/></fo:block>
	         </fo:table-cell>
	     </fo:table-row>
	     </fo:table-header>
        ...
        <fo:table space-before.optimum="2pt" border-collapse="separate" font-size="10pt" border-width="0.5pt" border-style="normal">
            ...
            <fo:table-header>
                <fo:table-row font-weight="bold" font-size="10pt" border-width="0.5pt" border-style="solid">
                    ...
                    <fo:table-cell border-color="black" border-left-width="0.5pt" border-top-width="0.5pt" border-right-width="0.0pt" border-bottom-width="0.5pt" border-style="solid" height="10pt">
                        <fo:block text-align="center">投资人用户名</fo:block>
                    </fo:table-cell>
    ...
    <xsl:template match="InvestorRow">
        <fo:table-row space-before.optimum="3pt" font-size="10pt">
           ...
           <fo:table-cell text-align="start" border-color="black" border-left-width="0pt" border-top-width="0pt" border-right-width="0pt" border-bottom-width="0pt" border-style="solid" height="10pt">
            ...
            <fo:table-cell border-color="black" border-left-width="0.5pt" border-top-width="0pt" border-right-width="0pt" border-bottom-width="0.5pt" border-style="solid" height="10pt">
