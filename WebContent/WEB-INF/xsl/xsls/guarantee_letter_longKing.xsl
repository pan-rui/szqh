...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="PageList">
     ...
     <xsl:template match="TableLetter"> 
      ...
      <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">一、投资接受人经<xsl:value-of select="platformName"/>(以下简称<xsl:value-of select="productName"/>金融)接受注册，意向投资人融资,并承诺到期无条件回购投资人的投资权益（包含本金及收益）。担保人就投资接受人向投资人回购投资权益的行为和责任提供履约连带责任担保；</fo:block>     
      ...
      <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">如投资接受人不能按照《投资权益回购履约担保合同》之规定即在本担保函项下的投资权益在到期日足额支付相应本金及收益时，担保人在收到《代偿通知书》后于 3 个工作日内将代偿款足额划入担保人在<xsl:value-of select="productName"/>金融服务平台关联的易极付账户绑定的银行账户中，并完成全部代偿相关手续。 </fo:block>
