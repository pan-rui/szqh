    ...
    <xsl:template match="PageList">
     ...
     <xsl:template match="TableContract"> 
      ...
      <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">甲方：向发起借款标的借款人提供资金的投资人</fo:block>
       ...
       <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">乙方：发起借款标的借款人（投资接受人）</fo:block>
       
      <fo:block align="center" space-before="8pt" space-after="2pt" >
       <xsl:apply-templates select="financier"/>
      </fo:block>
      
      <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">丙方：中创晟业（北京）资本管理有限公司</fo:block>

         <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">丁方：承诺为乙方提供履约连带保证的担保公司</fo:block>
         ...
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             3、丙方基于甲方和乙方的委托，撮合甲乙双方依法建立借款法律关系，并为双方合同签订、借款交易完成、债权风险防范措施设定提供居间服务；</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         ...
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             3、乙方应在借款期限届满日12：00时前将还本付息的资金转入在“易极付”的账户，并自行发出指令将资金转入甲方在“易极付”的账户。到期日为月数届满的那个月中与收到借款日对应的“日”，该月无此对应日的，为该月最后一日。如截止日为非工作日，则顺延至此后第一个工作日。</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
         ...
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             2、丁方与乙方确认，双方之间的担保合同已签订并生效且担保措施已落实，只要发生乙方到期不能偿还借款本息的情况，丁方将立即为乙方代偿，以保证甲方投资款本息按时收回。</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             3、如果在本合同约定的还款期限届满日12：00时前乙方仍未足额偿还甲方借款本息，则与乙方共同对甲方承担偿还借款本息的责任，以及共同承担本合同约定的违约责任。</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             4、如果发生乙方逾期偿还借款本息的情况，不仅丁方自动与乙方成为甲方的共同债务人，丙方有义务协调、督促以及采取其他有效措施督促丁方立即履行还款义务，以确保甲方收回投资本息不会发生过度迟延。</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             第八条	  服务费与税金</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
             1、就丙方提供的居间服务，甲乙双方均应向丙方支付服务费，但为简化操作，甲方应付服务费采用让渡利息的方式转移给乙方，由乙方向丙方支付应由双方支付的居间服务费，双方承担但由乙方向丙方支付的居间服务费等由丙方根据市场行情变化和项目具体情形等自行确定。本合同第三条约定的利率，是甲方已经让渡利息以后的执行利率，因此，实际由乙方单方向丙方支付居间服务费对本合同第二条约定利率不产生任何影响。</fo:block>
         <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="25px"  space-before="8pt" space-after="2pt"  line-height="17pt">
            ...
            <fo:table-body>
	            <fo:table-row space-before.optimum="3pt" font-size="10pt">
	             ...
	             <fo:table-row space-before.optimum="3pt" font-size="10pt">
				            ...
				            <fo:table-cell border-color="black" border-left-width="0.5pt" border-top-width="0pt" border-right-width="0.5pt" border-bottom-width="0.5pt" border-style="solid" height="10pt">
				                <fo:block text-align="left" margin-left="5px" >
				                    <xsl:value-of select="SYYYY"/>  <xsl:value-of select="EYYYY"/> 年 <xsl:value-of select="EMM"/> 月 <xsl:value-of select="EDD"/>日 的下一工作日
				                </fo:block>
				            </fo:table-cell>
	             </fo:table-row>  
