...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="PageList">
     ...
     <xsl:template match="TableContract"> 
      ...
      <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">平台运营商：<xsl:value-of select="platformName"/></fo:block>
      
      <fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt"> 担保公司：以平台公示的相关《担保承诺函》对应的担保公司为准:</fo:block>
      
      <fo:block  space-before="8pt" space-after="2pt" >
       <xsl:apply-templates select="guaranteeLetter"/>
      </fo:block>
      
      <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">投资人、投资接受人、担保公司都是在<xsl:value-of select="platformName"/>网站（以下称“<xsl:value-of select="productName"/>金融服务平台”）上合法注册的主体。投资人同意向投资接受人提供约定期限的投资，投资接受人承诺到期无条件回购投资人的全部投资权益（包含本金和收益），同时担保公司为投资接受人向投资人到期无条件回购投资人的投资权益（包含本金及收益）提供履约连带责任担保。</fo:block>     
      ...
      <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">2.投资接受人：是指在<xsl:value-of select="productName"/>金融服务平台注册并同意相关服务协议，有资金需求及合法资金用途，承诺在到期时间无条件回购投资人的投资权益（包含本金和收益），并获得担保公司履约连带责任担保的自然人。</fo:block>      
       ...
       <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.承诺提供的信息真实有效，投资资金来源合法，自愿向投资接受人进行投资形成投资权益（包含本金和收益）。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">5.当投资接受人或担保公司按照本合同约定履行了偿付义务，投资人同意并在此不可撤销地授权由重庆德同网络信息技术有限公司代其向担保公司出具《解除担保责任告知函》或《代偿债务确认书》。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">6.若担保公司在保后调查中发现投资接受人发生影响其履约能力的任一情况，投资人在此同意并不可撤销地授权由担保公司代其宣布提前收回投资收益或回购日提前到期。</fo:block>
	   ...
	   <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.承诺提供的信息真实有效，不得隐瞒任何影响或可能影响其资信能力的事项。</fo:block>      
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">3.在筹集期满次日登录<xsl:value-of select="productName"/>金融服务平台确认本合同，并支付相关费用。具体金额计算方式以<xsl:value-of select="productName"/>金融服务平台提供的费用计算规则为准。</fo:block>      
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">6.当投资接受人不能对投资人进行按时、足额回购投资权益（含投资人本金和收益）时，投资接受人同意并在此不可撤销地授权由重庆德同网络信息技术有限公司代其向担保公司出具《代偿通知书》。</fo:block>  
		
		<fo:block  font-weight="bold" wrap-option="wrap" language="zh" text-align="left" text-indent="0px"  space-before="8pt" space-after="2pt"  line-height="17pt">（三）担保公司的权利义务 </fo:block> 
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">5.在投资接受人未按照本合同第三条（二）第4条的规定履行回购投资人权益（包含本金和收益）的义务时，按照其对投资接受人的履约担保条款，于到期时间后的三个工作日内向投资者足额代偿相关款项，具体的代偿金额计算方式以<xsl:value-of select="productName"/>金融服务平台提供的费用计算规则为准。</fo:block> 
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">7.担保公司保证的范围包括《投资权益回购履约担保合同》项下的本金、收益、违约金。</fo:block> 
        ...
        <fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.投资接受人可在正常投资期间任一工作日提前履约回购投资权益和保证投资人收回全部本金及收益。投资接受人提前履约的，应一次性按合同订立时约定的收益率及投资期限进行履约，具体金额计算方式以<xsl:value-of select="productName"/>金融服务平台提供的费用计算规则为准。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">2.投资接受人未能于回购到期日履约的，担保公司需按照其对投资接受人的履约担保条款向投资者代偿相关款项。担保公司代偿后按照其与投资接受人事先约定的条款向投资接受人追偿该笔代偿金及违约金。具体计算方式以担保公司与投资接受人事先约定的违约金标准为准。<xsl:value-of select="productName"/>金融服务平台有权将投资接受人的违约行为在网站上公布并降低投资接受人的信用级别。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">3.投资接受人未能于回购到期日履行回购义务,导致担保公司承担履约担保责任代为回购投资权益的，投资接受人需承担担保公司因追偿而产生的所有费用（包括并不限于诉讼费用、律师费用、鉴定费、差旅费、保全费等）。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">2.投资接受人及担保公司对<xsl:value-of select="productName"/>金融服务平台记录的本合同投资总额项下的所有内容均予以承认并履行。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">3.投资接受人及担保公司须确保一次性足额回购本合同投资总额项下所有投资人的投资权益，保证所有投资人收回全部本金及收益，否则视为违约，由此引起的法律后果及违约责任由投资接受人及担保公司连带承担。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">4.投资接受人及担保公司对于含本合同在内的投资总额项下本金及收益的回购兑付操作（包括但不限于正常回购兑付、代偿兑付等）须登录<xsl:value-of select="productName"/>金融服务平台，通过各自在<xsl:value-of select="productName"/>金融服务平台关联的易极付账户绑定的银行账户向其易极付账户划转款项来完成，否则视为违约，由此引起的法律后果及违约责任由投资接受人及担保方连带承担。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">5.本合同项下的收款、兑付等数据信息均以<xsl:value-of select="productName"/>金融服务平台生成并公布的内容为准。投资人、投资接受人、担保公司可以随时登录<xsl:value-of select="productName"/>金融服务平台查阅投资、担保、收\付款信息。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">6.各方一致同意合同项下投资本金及收益通过以下路径兑付时约定如下：如兑付资金为担保公司划至其易极付账户用于代偿兑付投资人本金及收益的，该担保公司即享有向投资接受人追偿全部兑付资金的权利，投资接受人对此予以认可，且不存在任何异议，并承诺自担保公司兑付投资人投资权益（含投资本金及收益）之后，自愿以担保公司兑付的全部款项为基数，自兑付之日起以同期银行贷款利率的四倍为标准计算逾期利息一并支付给担保公司。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">7.本合同项下的投资收益权不得私下转让，转让须经过担保公司书面同意并在<xsl:value-of select="productName"/>金融服务平台登记方为有效。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">9.合同各方知悉并遵守《<xsl:value-of select="productName"/>金融服务平台服务协议》的规定，前述文本的修改必须经过担保公司书面同意，否则该等文本的修改对担保公司不产生任何效力。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">11.投资人、投资接受人及担保公司如因其银行账户发生销户、换卡、挂失和司法冻结等情况时，为保证业务正常开展，应重新绑定其它正常银行账户。如未及时绑定银行账户造成资金无法出入账的，须及时通知并申请<xsl:value-of select="productName"/>金融服务平台协助完成后续处理，并承担由此产生的不利后果及相应责任。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">12.<xsl:value-of select="productName"/>金融服务平台及易极付只提供投资人、投资接受人、担保公司及其绑定银行账户间的资金清结算服务，对业务中涉及的投资风险不承担任何担保、代偿的义务。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">13.<xsl:value-of select="productName"/>金融服务平台为投资人、投资接受人及担保公司提供信息发布、合同订立与登记服务；并根据合同约定提供投资人、投资接受人及担保公司在各自的<xsl:value-of select="productName"/>金融服务平台关联的易极付账户与各方绑定银行账户间的交易资金划转服务。投资人、投资接受人及担保公司绑定账户的安全性须自行管理及承担责任。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">14.投资人、投资接受人及担保公司应确保在<xsl:value-of select="productName"/>金融服务平台登记邮件、手机联系方式，并确保正确与通畅。<xsl:value-of select="productName"/>金融服务平台向各方登记联系方式发送的通知及信息，视为通知到达。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.《<xsl:value-of select="productName"/>金融服务平台服务协议》为本合同附件，与本合同具同等法律效力。</fo:block>
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">2.本合同受中华人民共和国法律管辖并按中华人民共和国法律解释。合同履行中发生争议，可由各方协商解决，协商不成可向担保公司所在地人民法院起诉。</fo:block>
		...
		<fo:block  wrap-option="wrap" language="zh" text-align="left" text-indent="20px"  space-before="8pt" space-after="2pt"  line-height="17pt">1.本合同为附条件生效合同，生效条件为：本合同在筹集期内达到投资接受人本次投资最低筹集金额；担保公司出具针对投资接受人及本合同涉及的投资人投资权益的担保函，并保存记录在<xsl:value-of select="productName"/>金融服务平台后，本合同生效。</fo:block>
